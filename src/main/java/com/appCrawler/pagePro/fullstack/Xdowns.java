...
public class Xdowns implements PageProcessor{
	...
	public Apk process(Page page) {
		...
		if(page.getHtml().links().regex("http://www\\.xdowns\\.com/soft/184/phone/Android/.*").match())
		{
	 		List<String> apps=page.getHtml().links("//ul[@class='p_list_7']").all();
		...
		if(page.getUrl().regex("http://www\\.xdowns\\.com/soft/184/phone/Android/\\d+/Soft_\\d+\\.html").match())
		{
			...
			Apk apk = Xdowns_Detail.getApkDetail(page);
