...
public class Paogame implements PageProcessor{
	...
	private Logger LOGGER = LoggerFactory.getLogger(Paogame.class);

	public Apk process(Page page) {
	
		if("http://www.paogame.com/game/".equals(page.getUrl().toString()))
		{
			page.addTargetRequest("http://www.paogame.com/netgame/");
			page.addTargetRequest("http://www.paogame.com/soft/");
			return null;
		}
	
		if(page.getHtml().links().regex("http://www.paogame.com/.*").match())
		{
				...
				||page.getUrl().regex("http://www\\.paogame\\.com/game/\\d+\\.html").match())
		{
			...
			Apk apk = Paogame_Detail.getApkDetail(page);
