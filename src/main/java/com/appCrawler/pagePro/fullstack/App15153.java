...
public class App15153 implements PageProcessor{
	...
	public Apk process(Page page) {
		...
		if("http://www.15153.com/".equals(page.getUrl().toString()))
		{
			for(int i=1;i<12;i++)
			{
				page.addTargetRequest("http://www.15153.com/android/0-"+i+"-0-0-0/");
			}
			//page.addTargetRequest("http://www.15153.com/android/list/1.html");
			return null;
		}
		
		if(page.getHtml().links().regex("http://www\\.15153\\.com/android/\\d+-\\d+-0-0-0/").match())
		{
		...
		if(page.getUrl().regex("http://www\\.15153\\.com/android/app/\\d+\\.html").match())
		{
			...
			Apk apk = App15153_Detail.getApkDetail(page);
