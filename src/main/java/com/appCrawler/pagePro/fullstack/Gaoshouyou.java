...
public class Gaoshouyou implements PageProcessor{
	...
	public Apk process(Page page) {
		...
		if("http://www.gaoshouyou.com/".equals(page.getUrl().toString()))
		{
			page.addTargetRequest("http://www.gaoshouyou.com/youxiku-0-1-0-0-0-0-1");
			return null;
		}
	
		if(page.getHtml().links().regex("http://www.gaoshouyou.com/youxiku-0-1-0-0-0-0-\\d+").match())
		{
			//List<String> categoryList=page.getHtml().xpath("//div[@class='apply-menu']/ul/li/a/@href").all();
	 		List<String> apps=page.getHtml().links("//ul[@class='game-list']").all();
		...
		if(page.getUrl().regex("http://www.gaoshouyou.com/youxiku/\\d+\\.html").match())
		{
			...
			Apk apk = Gaoshouyou_Detail.getApkDetail(page);
