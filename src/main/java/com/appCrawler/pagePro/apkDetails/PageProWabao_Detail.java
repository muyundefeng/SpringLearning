...
public class PageProWabao_Detail {
	private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(PageProWabao_Detail.class);
	public static Apk getApkDetail(Page page){
        ...
        if (page.getUrl().regex("http://www\\.tmsjyx\\.com").match()) {
         ...
         appDescription = html.xpath("//div[@class='pcontent']/text()").get();
        ...
        if (page.getUrl().regex("http://apk\\.hiapk\\.com/appinfo/.*").match()) {
           ...
           appDescription = html.xpath("//div[@class='font12 soft_des_box fixed_height']/pre/text()").get();
