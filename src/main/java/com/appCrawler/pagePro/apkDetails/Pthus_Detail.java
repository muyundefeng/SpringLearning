...
public class Pthus_Detail {
	private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(Pthus_Detail.class);
	public static Apk getApkDetail(Page page){
		...
		appName = page.getHtml().xpath("//div[@class='plac_d']/h2/span[1]/text()").toString();	
		appCategory = page.getHtml().xpath("//ul[@class='in_list']/li[1]/a/text()").toString();
		appUpdateDate = page.getHtml().xpath("//ul[@class='in_list']/li[3]/text()").toString();
		appDescription = page.getHtml().xpath("//p[@id='j_show']/text()").toString();
		appDescription = appDescription!=null?usefulInfo(appDescription):null;
		appScrenshot = page.getHtml().xpath("//ul[@class='ove_ul']/li/a/img/@src").all();
