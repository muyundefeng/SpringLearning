...
public class Down9_Detail {
	private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(Down9_Detail.class);
	public static Apk getApkDetail(Page page){
		...
		appName = page.getHtml().xpath("//div[@class='t']/h1/text()").toString();	
