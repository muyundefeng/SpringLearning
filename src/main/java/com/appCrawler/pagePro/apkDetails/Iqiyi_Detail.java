...
public class Iqiyi_Detail {
	private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(Iqiyi_Detail.class);
	public static Apk getApkDetail(Page page){
		...
		appName = page.getHtml().xpath("//div[@class='cont']/h2/text()").toString();	
		appScrenshot = page.getHtml().xpath("//ul[@class='adc_fImgbox']/li/a/img/@src").all();
		appDescription = page.getHtml().xpath("//div[@class='adc_items mt30']").toString();
