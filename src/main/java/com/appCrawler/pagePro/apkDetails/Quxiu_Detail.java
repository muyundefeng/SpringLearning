...
public class Quxiu_Detail {
	private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(Quxiu_Detail.class);
	public static Apk getApkDetail(Page page){
		...
		appName = page.getHtml().xpath("//div[@class='zlGd_gameInfo']/h3/text()").toString();	
		
		appDetailUrl = page.getUrl().toString();
		appCategory = page.getHtml().xpath("//div[@class='zlGd_gameInfo']/ul/li[1]/a/text()").toString();	
		appVenderName = page.getHtml().xpath("//div[@class='zlGd_gameInfo']/ul/li[3]/text()").toString();	
		appUpdateDate = page.getHtml().xpath("//div[@class='zlGd_gameInfo']/ul/li[5]/text()").toString();	
		appDescription=page.getHtml().xpath("//div[@class='down-content']").toString();
		appDescription=usefulInfo(appDescription);
		appScrenshot=page.getHtml().xpath("//ul[@class='donload-gameImages-list clearfix']/li/a/img/@src").all();
