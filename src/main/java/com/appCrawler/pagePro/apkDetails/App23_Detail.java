...
public class App23_Detail {
	private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(App23_Detail.class);
	public static Apk getApkDetail(Page page){
		...
		appDownloadUrl = page.getHtml().xpath("//div[@class='download-wrap-item js-show']/a[@class='a1']/@href").toString();
