...
public class Nexva_Detail {
	private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(Nexva_Detail.class);
	public static Apk getApkDetail(Page page){
		...
		appName = page.getHtml().xpath("//h2[@id='pageTitle']/text()").toString();	
		appScrenshot = page.getHtml().xpath("//div[@class='screenShots']/ul/li/a/img/@src").all();
		appDescription = page.getHtml().xpath("//div[@class='description']").toString();
