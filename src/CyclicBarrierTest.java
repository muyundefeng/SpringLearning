...
public class CyclicBarrierTest {
    ...
    public static class ComponentThread implements Runnable {
        ...
        public void run() {
            try {
                ...
                barrier.await();//等待所有线程到达，到达之后执行run函数里的内容,有等待线程的一个系西安
                System.out.println("Component " + ID + " awaked");
                // 计算数据数组中的当前值和后续值
                System.out.println("after="+array[0]+" "+array[1]+" "+array[2]);
    ...
    public static void testCyclicBarrier() {
        ...
        CyclicBarrier barrier = new CyclicBarrier(2, new Runnable() {
            // 在所有线程都到达Barrier时执行
            public void run() {
                System.out.println("testCy   clicBarrier run");
        ...
        System.out.println("this pase is called");
